...
\title{MASS MEDIA AND THE DOMESTIC POLITICS OF ECONOMIC GLOBALIZATION \vspace{.5em}}
\author{A Dissertation \\*
Submitted to \\*
the Temple University Graduate Board \\*
\vspace{2em}}

\date{In Partial Fulfillment \\*
...
\vspace{.5em}
Christopher Wlezien, Department of Political Science \\*
Orfeo Fioretos, Department of Political Science \\*
Roselyn Hsueh, Department of Political Science \\*
Miguel Glatzer, External Member, LaSalle University \\*
\end{flushleft}
}
...
This dissertation argues that the mass media have played a critical but misunderstood role in the variety of national political responses to economic globalization around the world since the 1960s. More specifically, quantitative as well as qualitative methods across three article-length studies demonstrate how mass media have played a variety of \emph{anti-democratic} roles in the domestic politics of economic globalization since the 1960s, in ways which have gone largely unnoticed by political scientists.

The first article, ``Mass Media and the Domestic Politics of Economic Globalization," argues that the mass media make welfare spending less responsive to domestic groups harmed by economic globalization. Statistical tests on state-level economic data as well as individual-level survey data are found to be consistent with this theory.

The second article, ``Media Ownership and the Social Construction of Economic Globalization," argues that the response of mass publics toward the global economic exposure of their country varies according to the degree of foreign ownership in the national media market. Statistical analysis of state-level media ownership data and aggregate public opinion data, combined with qualitative analyses of newspaper content, provides mixed evidence for the theory.
...
This manuscript would not have been possible without the generous support it has received from the Department of Political Science at Temple University. At Temple, a number of individuals have been especially crucial to the research collected here. Christopher Wlezien is perhaps more responsible than anyone for having shown me the value of quantitative methods and for demonstrating the social-scientific ethos of a true commitment to rigor, that sincere devotion to really ``getting it right," as I often hear him saying over my shoulder. Orfeo Fioretos has been an equally valuable critic and supporter of this research, reading and commenting on this entire manuscript very closely more times than he needed to; also, he has understood and encouraged me intellectually and personally during those times when life has came into tension with my academic work. Although I never had the privilege of doing coursework under her, Roselyn Hsueh has provided invaluable feedback on several drafts of this manuscript and her support has been steadfast from the very beginning. Many thanks are also due to Miguel Glatzer for his very thoughtful engagement with my work as external reader on the dissertation committee. And finally, of course, this work has been buoyed by many friends and family members who have supported me even at my most curmudgeonly. Almost needless to say, any remaining errors or shortcomings in this manuscript are my own. 
...
theory (\citealt{Horkheimer:2009te,adorno2001culture,Debord:1967vn}). Eventually, however, these currents were superceded by the Colombia and Michigan schools of voting research (\citealt{Lazarsfeld:XL9DE-We,katz1970personal,campbell1980american}, both of which tended to stress the ``limited effects'' of media and would ultimately constitute the baseline for most future social science research on media effects. Thus, while the findings here speak against the belief of contemporary social science in the ``limited effects'' of media, it is worth nothing that the balance of evidence herein is broadly in line with a tradition in modern social thought even longer-standing than the tradition of limited effects.} The results of this dissertation suggest that variation across domestic media environments represent a significant factor which helps us understand broad
...
instance, the many neoliberal economic openings of the late 1980s and 1990s).

The specific findings of this dissertation and their larger implications will be of interest to three areas of political science research. First, for the study of international and comparative political economy, the evidence from this dissertation suggests that under certain conditions the mass media function as a political \emph{institution} mediating the domestic political responses to economic globalization. While there is widespread consensus that domestic institutions are critical in shaping the domestic politics around economic globalization (\citealt{Garrett:1995tf,Adsera:2002vt,Frieden:1996tf,glatzer2004globalization}), most research in this area focuses on what Garrett and Lange call either ``socioeconomic institutions'' such as labor market institutions or ``formal institutions'' such as those which distinguish democratic and autocratic regimes. Yet, national mass media environments are essentially domestic political institutions because they function as state-level context for individual-level phenomen and their patterns of variation across countries are widely agreed to represent distinct systems (\citealt{Baek:2009vq,Baum:2012je}), their composition is determined strategically by interested actors (\citealt{Corrales:2006vz}), and because their ``mass'' nature implies that their effects, if any, are likely to affect mass publics in general (\citealt{Camber:2013ul}).

The focus on socioeconomic and formal institutions in international and comparative political economy has led this tradition to undertheorize the role of information and communication in shaping domestic political responses to economic globalization. This dissertation responds to this lacuna and makes a novel contribution to this field of research by exploring three specific ways in which the domestic media environment functions as a state-level political institution which can be conceptualized and studied using the same basic theoretical frameworks and methodological approaches commonly used to study socioeconomic and formal political institutions. Although the results are mixed, this dissertation shows that accounting for the domestic media environment robustly explains certain dimensinos of variance in domestic political responses to globalization hitherto left unexplained by socioeconomic and formal political institutions.

Scholars of political communications will be interested to find in this dissertation fresh evidence that under certain conditions the mass media might shape not only public opinion but certain concrete outcomes in domestic political and economic conflicts. In political communications research, where the conventional wisdom is that the media have ``limited effects'' in directly shaping perceptions and behaviors (\citealt{Klapper:1957if,katz1970personal,Pooley:2006iq}), this dissertation represents a novel challenge. By exploiting state-level data on mass media penetration as well as the individual-level survey data typical of media-effects research in political communications (\citealt{Katz:1987kq,WahlJorgensen:2004ht}, this dissertation suggests that under certain conditions the media may have larger and more substantively important effects than is typically believed in political communications research. Additionally, scholars of political communications today recognize the importance of a free media for a healthy and functioning democracy (\citealt{WhittenWoodring:2012ix}), but many argue that even free media in the long-run tend to strengthen the power of the state relative to citizens (\citealt{Deutsch:1953ww,Deutsch:1966ux,Camber:2013ul}). The findings of this dissertation converge not only to challenge the conventional expectations of ``limited effects,'' but also in broad support of the perspective that the rise of modern mass media has strengthened the power of states and national elites rather than citizens. Finally, the mixed-methods approach taken here will be of particular interest to the broader academic world of Media Studies, which has long been a source of strong claims about the effects of media on politics, but which has remained largely qualitative and often unable to control for alternative explanations (\citealt{Debord:1967vn,McLuhan:1994tf,Chomsky:1991ty,Gitlin:1978gg}).  

The overall picture that emerges from integrating political communications research with international and comparative political economy is important for our understanding of democracy in an increasingly globalized world. The convergence of implications speaks most usefully to the literature on the globalization-democracy nexus. The debate among political economists regarding the relationship between economic globalization and democracy remains contentious, with many finding evidence that economic openness leads to greater democracy (\citealt{Lipset:1959wr,EICHENGREEN:2008gg,LopezCordova:2005wh}); many others finding evidence that economic openness is negatively associated with democracy (\citealt{acemoglu2009economic,Li:2003vj,boix2003democracy}); and still others finding null effects (\citealt{ECOT:ECOT226,Decker:2009df,Milner:2009hi}). The three studies of this dissertation contribute to the agenda of developing a better understanding of the domestic conditions which shape the globalization-democracy nexus (\citealt{Milner:2009hi,boix2003democracy}), by introducing a hitherto unconsidered type of domestic variation (mass media) and considering not democracy per se but the democratic quality of important outcomes such as welfare spending, public opinion formation, and media freedom.

The studies which follow connect all of these often very disconnected conversations, finding mixed but sometimes strong evidence that the spread of mass media, whether it be due to inherent tendencies or its strategic manipulation and repression by elites, has functioned in the past several decades to make economic policymaking less fully accountable to domestic mass publics than it would have been in the absence of increasingly mass-mediatized information and communication environments. As the first systematic attempt to bring each of these large and contentious debates to bear on each other, this dissertation will thus be of interest to academics, activists, and policymakers interested in better understanding or reshaping either one of these traditionally disconnected areas of research and practical politics. 
...
liberalization. I argue that repressive interventions into the media environment are a strategic choice for globalizing and even democratizing state leaders because, as traditional overt repression is discouraged by increasing international economic and political linkages, leaders often maintain a more subtle repertoire of repressive techniques (\citealt{Levitsky:2006ex,Levitsky:2002gx}). Media repression is likely to be uniquely attractive to globalizing leaders because it is relatively subtle and  legalistic, but also because it often seeks to dampen the publicity of various other improprieties which can emerge in liberalization but are condemned by the international community, such as corruption and cronyism.

In the long run, however, different types of economic openness are expected to exert different
pressures on media freedom depending on how much they reward transparency. I argue that financial
openness should lead to greater media freedom in the long run because transparency is important to capital
markets, but trade openness should not exert any positive effect on media freedom in the long run because
...
However, one area of research in comparative political behavior shows that as
...
converges on the following set of arguments: \emph{By shifting citizen blame attributions away
...
openness. In turn, national policymakers face less pressure to compensate protectionist domestic groups for economic hardships linked to the global economy. Thus, as states become increasingly penetrated by both the global economy and mass media,
...
(\citealt[474]{Hays:2005vo}). At the same time, findings from various subfields in political science
...
placing responsibility on governments. Indeed, Colin Hay and others have shown at great length the degree to which politicians deploy the concept of globalization to justify and rationalize their policy choices as imperative or inevitable (\citealt{Hay:2011dh,Smith:2008fs}). Other work has shown that under certain conditions mass media
...
levels of analysis.\footnote{Full summary statistics for both datasets can be found in the appendix for this chapter.} The individual-level data come from a Legidoscope survey of public opinion in France
...
attribution, media exposure, and political mobilization.\footnote{See the appendix for the
...
``society'' or ``people like you and me.''} $General\: Problem\: Type$ is a categorical variable
...
The present theory is agnostic about whether or not perceptions of openness as a top problem makes
...
Why are more trade-open countries more likely to repress the media, even though media freedom is
positively correlated with most other components of economic globalization? To explore and
understand this empirical puzzle, I study the contradictory pressures economic globalization exerts
on state-media relations. On the one hand, economic openness encourages
national policymakers to promote media freedom because foreign investors are more likely to invest
where information is reliable. On the other hand, because adjusting to economic openness implies
distributive conflict which can threaten the government, openness also generates incentives for
national policymakers to suppress information and communication about the costs of liberalization.
This paper develops a theoretical model that reconciles these contradictory expectations by
disaggregating economic globalization into its component parts and distinguishing changes in economic globalization
(liberalization) from levels (openness). I argue that liberalization of
trade, inward foreign direct investment, and inward capital flows increase the probability states
will repress the media, as states seek to quell domestic conflict around the adjustment costs of
...
relationship between trade and media freedom is weakly negative.\footnote{Disaggregated economic
data come from the World Bank Development Indicators (\citealt{WorldDevelopmentIn:2012wl}) and data
on media freedom come from Freedom House (\citealt{FreedomHouse:2011vv}) and Van Belle's Global Press Freedom Dataset
...
country conditions before it would even be reported by free media (\citealt{Dube:2011ir}).
...
long-run effects, while qualitative process-tracing is used to ``triangulate'' on the causal
process (\citealt[29]{brady2004rethinking}).
...
variable, I use the well-known Freedom of the Press scores from Freedom House (\citealt{FreedomHouse:2011vv}) as well as
the the Global Media Freedom Database by Douglas Van Belle (\citeyear{Belle:1997wo,van2000press}). Freedom
...
sectional time-series regression techniques suited to this purpose.
...
\begin{figure}
\includegraphics[scale=0.18]{article2_regions.png}
...
\subsection{Case Study of Argentina}
...
especially democratic regimes, will compensate domestic losers from liberalization in order to
...
\subsection{Case Study of Mexico}
...
This narrative reveals dynamics which are unexpected and in a crucial sense antithetical to the theory presented here, for they reveal how economic liberalization may induce greater media freedom by increasing
...
favor a free, independent media, as evidenced especially in the case of Mexico. If this is the case, then it would provide a warrant for expecting trade liberalization to be associated with media freedom in the long run, as the conventional wisdom
...
associated with increased domestic competition. Another possibility is that the short-run negative effects which trade
exerts on media freedom decay slowly and outweigh the postive effects of any domestic competition which is intensified by
...
\chapter{Conclusion of the Dissertation}
...
\section{Substantive Implications for Democracy under Economic Globalization}
...
\section{Implications for Political Science and Future Research}
...
\caption{Alternative DV for Model 1 in Chapter 2: Blame Government vs. Any Other}
\end{figure}
\end{center}

\begin{center}
\include{article1_table1.B}
\end{center}
...
\caption{Alternative DV for Model 1 in Chapter 2: Blame International vs. Any Other}
\end{figure}
\end{center}
...
\begin{center}
\input{article1_table1.C.tex}
\end{center}

\pagebreak

\begin{center}
\input{article1_table1.2.tex}
\end{center}
...
\caption{Alternative DV for Model 2 in Chapter 2: Government Handling}
\end{figure}
\end{center}

\begin{center}
\input{article1_table2.A.tex}
\end{center}

\begin{center}
\begin{figure}
\includegraphics{article1_pressat_coefs}
\caption{Second Alternative DV for Model 2 in Chapter 2: Presidential Satisfaction}
\end{figure}
\end{center}

\begin{center}
\input{article1_table1.1.tex}
\end{center}

\begin{center}
\begin{flushleft}
\input{article1_state_vars.tex}

\clearpage

\input{article1_state_vars_summary.tex}
